...
fp_all_events = '/Users/wwneuro/My_Drive/Lab/Data_analysis/slice_NT/all_mini_events_by_cell/';
...
for eii = 1:numel(selected_mini_events)
    ...
    [cu_X, cu_Y] = cumhist(curr_cond,[min_amp,max_amp],0.001);
...
if save_results == 1
    ...
    save(strcat(exp_name,'_2024','.mat'),'all_mini_events','cell_id_index',...
